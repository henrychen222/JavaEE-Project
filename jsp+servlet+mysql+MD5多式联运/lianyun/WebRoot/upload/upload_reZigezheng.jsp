...
<script language="javascript">
    document.write("上传成功");
	window.parent.document.getElementById("zigezhengFujian").value="/upload/<%= newFile1Name%>";
	window.parent.document.getElementById("zigezhengFujianYuanshiming").value="<%= file_name%>";
</script>
