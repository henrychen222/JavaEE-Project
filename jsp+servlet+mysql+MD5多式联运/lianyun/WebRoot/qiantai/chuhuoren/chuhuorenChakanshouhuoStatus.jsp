		  ...
		  <TR>
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
		        ...
		        <a href="<%=path %>/yunshu?type=chuhuorenChakanYunshu" style="color:green;font-size:20px">查看运输费用</a><br/>
		        <form action="<%=path %>/shouhuoren?type=shouhuorenSearch1" method="post">
				...
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/img/tbg.gif">出货人查看收货状态&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<c:if test="${shouhuoren.shouhuoStatus=='未收货'}">
					<td bgcolor="#FFFFFF" align="center" style="color:green">
						 ${shouhuoren.shouhuoStatus}
					</td>
					</c:if>
					<c:if test="${shouhuoren.shouhuoStatus=='已收货'}">
