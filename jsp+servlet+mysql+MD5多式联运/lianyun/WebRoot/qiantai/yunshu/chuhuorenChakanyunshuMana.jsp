		  ...
		  <TR>
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
		        ...
		        <form action="<%=path %>/yunshu?type=yunshuSearch" method="post">
		        <b style="font-size:15px">出货人姓名：</b><input type="text" name="chuhuorenName"/>&nbsp;
		         <b style="font-size:15px">运输方式：</b><select name="yunshuStyle">
				...
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/img/tbg.gif">出货人查看运输费用&nbsp;</td>
				</tr>
