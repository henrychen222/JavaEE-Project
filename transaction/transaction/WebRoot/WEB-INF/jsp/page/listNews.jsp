	  	...
	  	<div class="row"style="margin-top: 5px;">
	  		<div class="panel panel-primary">
				...
				<c:forEach var="news" items="${news}">
					<tr>
						<td>
							<a href="${pageContext.request.contextPath }/servlet/NewsManager?actiontype=showNews&id=${news.id}" target="_blank" title="${news.title }">
								<c:out value="${fn:substring(news.title,0,20)}"></c:out>
				        		<c:if test="${fn:length(news.title)>20}">···</c:if>
				        	</a>
				        </td>
