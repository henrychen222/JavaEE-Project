  ...
  <body>
		...
		<div class="row">
			<div class="panel panel-primary">
				...
				<div class="panel-heading">管理员更新页面</div>
				<div class="panel-body">
					<form target="main" action="${pageContext.request.contextPath}/servlet/AdminManager?actiontype=update&action=updateAdmin&id=${list.id}" method="post">
