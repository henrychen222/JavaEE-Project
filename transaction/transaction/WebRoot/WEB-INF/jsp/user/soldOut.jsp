...
<div class="panel panel-success" style="margin-bottom:0px;">
  ...
  <c:if test="${!empty pagebean.list}">
  	  <div class="container" style="width:100%;">
  		<div class="row">
			<div class="panel panel-primary" >
		  		<div class="panel-heading">所有下架物品</div>
		 		<div class="panel-body">
					<table class="table table-bordered" >
					   ...
					   <tr>
					   	   <td><img width=140px height=160px src="${product.getUploadImage()}"/></td>
		                   <td>${product.name}</td>
						   <td>${product.price}</td>
		                   ...
		                   <td>${product.purchaser}</td>
						    <td>
							<a href="javascript:void(0)"title="删除" onclick="deleteProduct(${product.id})">[删除]</a>
							</td>
					   </tr>
					   </c:forEach>
					  </table>
  	 ...
  	 <script type="text/javascript">
		...
		{
			var b = window.confirm("确定要删除该宝贝 吗？");
			if(b)
				window.location.href="${pageContext.request.contextPath}/servlet/UserServlet?actiontype=deleteSoldOutProduct&id="+id;
		}
