...
<html>
	...
	<body style="background-color: 00ced1">
		...
		<form name="form"
			action="${pageContext.request.contextPath }/servlet/UserServlet?actiontype=${action}&URL=${URL}" onsubmit="return test()" method="post">
			<div class="container">
				<div class="row" style="opacity: 0.85;">
					...
					<div class="panel panel-info" style="margin: 10% auto; width: 33%;">
						...
						<font color="red" size=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${message }</font>
							...
							<div  style="margin: 25px 0;" class="input-group input-group-sm">
