	...
	<style type="text/css">
      ...
      <script language="javascript">
               ...
               function jingyingrenEdit(id)
           {
            ...
            function apply(){
            window.location.href="<%=path %>/chuhuoren?type=chakanChuhuoren"
           } 
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
				...
				<tr align="center" bgcolor="#FAFAF1" height="22">
					...
					<td width="10%">多式联运经营人编号</td>
					<td width="10%">姓名</td>
					<td width="5%">性别</td>
					<td width="5%">年龄</td>
					<td width="10%">资格证附件</td>
					<td width="10%">经验</td>
					<td width="10%">公司</td>
					<td width="10%">操作</td>
		        </tr>	
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				    ...
				    <td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.id}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.name}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.sex}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.age}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 <div onmouseover = "over('<%=path %>/upload/${requestScope.jingyingren.zigezhengFujianYuanshiming}')" onmouseout = "out()" style="cursor:hand;">
							查看图片
					   </div>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.jingyan}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.jingyingren.gongsi}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="查看申请表" onclick="apply()"/>
						<input type="button" value="修改" onclick="jingyingrenEdit( ${requestScope.jingyingren.id})"/>
					</td>
