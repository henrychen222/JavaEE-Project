	...
	<style type="text/css">
      ...
      <script language="javascript">
		    ...
		    function Xinxi(id)
           {
                   ...
                   window.location.href="<%=path %>/shouhuoren?type=shouhuorenManaxinxi&id="+id;
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
		        <TR>
		          ...
		          <input type="button" value="收货人注册" onclick="shouhuorenAdd()"/><br/>
		              <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/img/tbg.gif">收货人注册&nbsp;</td>
				</tr>
				
				<c:forEach items="${requestScope.shouhuorenList}" var="shouhuoren" varStatus="ss">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<c:if test="${sessionScope.user.loginname==shouhuoren.name}">
					<td bgcolor="#FFFFFF" align="right" > 
					<div style="align:right">点击图片查看详细信息</div>
					 
					<a href="#" onclick="Xinxi(${shouhuoren.id})"><img src="<%=path %>/upload/${shouhuoren.fujianYuanshiming}"/></a>
					
					</td>
					
					<td align="left" bgcolor="#FFFFFF">
					姓名：${shouhuoren.name}<br/>
