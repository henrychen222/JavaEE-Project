  ...
  <head>
	...
	<style type="text/css">
      ...
      <script language="javascript">
             function shouhuorenAdd()
             {
                var url="<%=path %>/qiantai/shouhuoren/shouhuorenAdd.jsp";
               ...
               function shouhuorenEdit(id)
           {
              
                   window.location.href="<%=path %>/shouhuoren?type=shouhuorenQuery&id="+id;
               
           }
          
            function shouhuo(id){
            
            window.location.href="<%=path %>/shouhuoren?type=shouhuorenUpdateshouhuoStatus&id="+id;
		  ...
		  <TR>
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
				...
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/img/tbg.gif">收货人信息管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				    ...
				    <td bgcolor="#FFFFFF" align="center">
						 ${requestScope.shouhuoren.id}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.shouhuoren.name}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.shouhuoren.tel}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.shouhuoren.address}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						 ${requestScope.shouhuoren.productName}
					</td>
					<c:if test="${requestScope.shouhuoren.shouhuoStatus=='未收货'}">
					<td bgcolor="#FFFFFF" align="center" style="color:green">
						 ${requestScope.shouhuoren.shouhuoStatus}
					</td>
					</c:if>
					<c:if test="${requestScope.shouhuoren.shouhuoStatus=='已收货'}">
					...
					<c:if test="${requestScope.shouhuoren.shouhuoStatus=='未收货'}">
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="确定收货" onclick="shouhuo( ${requestScope.shouhuoren.id})"/>
						<input type="button" value="修改" onclick="shouhuorenEdit( ${requestScope.shouhuoren.id})"/>
					</td>
					</c:if>
					<c:if test="${requestScope.shouhuoren.shouhuoStatus=='已收货'}">
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="确定收货" disabled="disabled" onclick="shouhuo( ${requestScope.shouhuoren.id})"/>
