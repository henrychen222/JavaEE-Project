	...
	<style type="text/css">
      ...
      <script language="javascript">
		    ...
		    function Xinxi(id)
           {
                   ...
                   window.location.href="<%=path %>/chuhuoren?type=chuhuorenManaxinxi&id="+id;
		    ...
		    <TD class=b vAlign=top width=591 align=left>
		      ...
		      <TABLE border=0 cellSpacing=0 cellPadding=2 width=590 align=left height=133>
		        <TR>
		          ...
		          <input type="button" value="出货人填写申请" onclick="chuhuorenAdd()"/><br/>
		              <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="14" background="<%=path %>/img/tbg.gif">出货人申请&nbsp;</td>
				</tr>
				
				<c:forEach items="${requestScope.chuhuorenList}" var="chuhuoren" varStatus="ss">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<c:if test="${sessionScope.user.loginname==chuhuoren.name}">
					<td bgcolor="#FFFFFF" align="right" > 
					<div style="align:right">点击图片查看详细信息</div>
					 
					<a href="#" onclick="Xinxi(${chuhuoren.id})"><img src="<%=path %>/upload/${chuhuoren.fujianYuanshiming}"/></a>
					
					</td>
					
					<td align="left" bgcolor="#FFFFFF">
					姓名：${chuhuoren.name}<br/>
					性别：${chuhuoren.sex}<br/>
					年龄：${chuhuoren.age}<br/>
					</td>
					</c:if>
