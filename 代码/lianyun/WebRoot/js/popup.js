...
build:function(){
   ...
   //var close='<input type="image" id="dialogBoxClose" src="'+path+'dialogclose.gif" border="0" width="16" height="16" align="absmiddle" />';
   var close='<img id="dialogBoxClose" title="关闭" src=/jiudian/img/dialogclose.gif  />';
