...
<body style="background-color:00ced1">
		<form onsubmit="" name="form"
			action="${pageContext.request.contextPath }/userController/register.action" method="post">						
				...
				<div class="container">
					...
					<div class="panel panel-info" style="margin: 10% auto; width: 33%;">
						...
						<div style="padding-left: 15%" class="panel-body">
							...
							<button  style="width: 36%;margin: 20px 0px 0px 60px" type="submit"  title="注册 " class="btn btn-primary">
									注&nbsp;&nbsp;&nbsp;&nbsp;册
								</button>
