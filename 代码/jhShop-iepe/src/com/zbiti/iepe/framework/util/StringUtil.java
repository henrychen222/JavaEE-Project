...
public class StringUtil
{
	...
	{
		if (str == null || str == "" || str.equalsIgnoreCase("null") || str.trim().length() < 1)
			return false;
		return true;
	}
	...
	{
		if (str == null || "".equalsIgnoreCase(str.toString()) || str.toString().trim().length() < 1)
			return false;
		return true;
	}
	...
	public static String formatCurrencyNum(String symbolCurr)
	{
		...
		try
		{
			...
			if (symbolCurr.contains("."))
			{
				...
				String integer = nt_number.substring(0, nt_number.lastIndexOf(digits));
