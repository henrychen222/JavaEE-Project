...
<html>
  ...
  <body class="easyui-layout">
  	<div data-options="region:'north'" style="height:200px;padding-top:10px;">
	    <form id="${domainObjectName}Form" style="padding:0px;margin:0px;">
  	...
  	<div data-options="region:'center'">
		<table id="${domainObjectName}Grid" class="easyui-datagrid" data-options="border:false,fit:true,nowrap:false,pageSize:20,
				striped:true,singleSelect:true,pagination:true,url:'${domainObjectName}/list.do'">
			<thead>
				<tr>
